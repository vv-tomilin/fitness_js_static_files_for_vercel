...
var form = function form() {
  var abonementForm = document.querySelector('.popup .form');
  var inputs = document.querySelectorAll('input');
  var selects = document.querySelectorAll('select');
  var modal = document.querySelector('.popup');
  var formStatus = document.querySelector('.form-status');
  var formStatusLoading = formStatus.querySelector('.form-status__loading');
  var formStatusSuccess = formStatus.querySelector('.form-status__success');
  var formStatusFailure = formStatus.querySelector('.form-status__failure');
  ...
  abonementForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData(abonementForm);
    postData('db/server.php', formData).then(function (res) {
      console.log(res);
  ...
  function showStatus(statusBlockSelector, showStatusSelector) {
    var hideStatusSelectors = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
    ...
    if (showStatusSelector.classList.contains('popup--hide')) {
      ...
      hideStatusSelectors.forEach(function (hideSelector) {
...
/***/ "./src/js/modules/headerMenuToggle.js":
/*!********************************************!*\
  !*** ./src/js/modules/headerMenuToggle.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var headerMenuToggle = function headerMenuToggle() {
  var menuToggle = document.querySelector('.header__menu-toggle');
  var modalBlock = document.querySelector('.header__menu-mobile-modal');
  var mobileMenuItems = document.querySelectorAll('.header__menu-mobile-modal-item');
  var desktopMenuItems = document.querySelectorAll('.header__desktop-menu-item');
  var promosSection = document.getElementById('promos');
  var addressesSection = document.getElementById('addresses');
  var aboutClubSection = document.getElementById('about-club');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (headerMenuToggle);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    var i = 0;
    var defines = matrix.replace(/\D/g, '');
...
var modal = function modal() {
  ...
  var abonementSelect = document.getElementById('abonement-select'); //const abonementOptions = abonementSelect.options; //! для использования с HTML коллекцией
...
/***/ "./src/js/modules/sliders/descriptionSlider.js":
/*!*****************************************************!*\
  !*** ./src/js/modules/sliders/descriptionSlider.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var descriptionSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__.default(".description-swiper", {
  slidesPerView: 2.2,
  spaceBetween: 10,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (descriptionSwiper);

/***/ }),

/***/ "./src/js/modules/sliders/introSlider.js":
/*!***********************************************!*\
  !*** ./src/js/modules/sliders/introSlider.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var introSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__.default(".intro-swiper", {
  spaceBetween: 30,
  centeredSlides: true,
  effect: 'fade',
  autoplay: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (introSwiper);
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    var timerSelector = document.querySelector(selector);
    var days = timerSelector.querySelector('#days');
    var hours = timerSelector.querySelector('#hours');
    var minutes = timerSelector.querySelector('#minutes');
    var seconds = timerSelector.querySelector('#seconds');
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_sliders_introSlider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/sliders/introSlider */ "./src/js/modules/sliders/introSlider.js");
/* harmony import */ var _modules_sliders_descriptionSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders/descriptionSlider */ "./src/js/modules/sliders/descriptionSlider.js");
/* harmony import */ var _modules_headerMenuToggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/headerMenuToggle */ "./src/js/modules/headerMenuToggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  _modules_sliders_introSlider__WEBPACK_IMPORTED_MODULE_0__.default;
  _modules_sliders_descriptionSlider__WEBPACK_IMPORTED_MODULE_1__.default;
  (0,_modules_headerMenuToggle__WEBPACK_IMPORTED_MODULE_2__.default)();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.default)();
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__.default)('.promos__timer', deadline);
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_5__.default)();
  (0,_modules_mask__WEBPACK_IMPORTED_MODULE_6__.default)('[name="user_phone"]');
});
})();
